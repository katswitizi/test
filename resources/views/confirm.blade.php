		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form action="{{ route('storeConfirm') }}" method="post">
                    {{ csrf_field()}}
                    <div class="d-flex justify-content-center links">
                    رابط الإنضمام إلى المجموعة
					</div>
						<div class="d-flex justify-content-center mt-3 login_container">
							<input type="number" id="num" name="num" class="form-control" style="text-align:right;" placeholder="أدخل رمز التأكيد الذي تلقيته" required>
						</div>
							<div class="d-flex justify-content-center mt-3 login_container">
				 	<button type="submit" name="button" class="btn btn-success btn-block">تاكيد</button>
				   </div>
					</form>
				</div>
